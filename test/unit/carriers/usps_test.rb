...
class USPSTest < ActiveSupport::TestCase
  ...
  def test_strip_9_digit_zip_codes
    request = URI.decode_www_form_component(@carrier.send(:build_us_rate_request, package_fixtures[:book], "90210-1234", "123456789"))
  ...
  def test_strip_9_digit_zip_codes_world_rates
    request = URI.decode_www_form_component(@carrier.send(:build_world_rate_request, location_fixtures[:beverly_hills_9_zip],
